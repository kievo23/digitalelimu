                ...
                <div class="panel-body">
                    ...
                    <form class="form-horizontal" role="form" method="POST" action="{{ url('/content/update',['id'=>$content->id]) }}" enctype="multipart/form-data">
                        ...
                        <div class="form-group{{ $errors->has('name') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-10">
                                <input id="name" type="text" class="form-control" name="name" value="{{ $content->name }}" autofocus>
                        ...
                        <div class="form-group{{ $errors->has('term') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-10">
                                <input id="term" type="text" class="form-control" name="term" value="{{ $content->term }}" autofocus>
                        ...
                        <div class="form-group{{ $errors->has('week') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-10">
                                <input id="week" type="text" class="form-control" name="week" value="{{ $content->week }}" autofocus>
                        ...
                        <div class="form-group{{ $errors->has('lesson') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-10">
                                <input id="lesson" type="text" class="form-control" name="lesson" value="{{ $content->lesson }}" autofocus>
                        ...
                        <div class="form-group{{ $errors->has('description') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-10">
                                <input id="description" type="text" class="form-control" name="description" value="{{ $content->description }}" autofocus>
